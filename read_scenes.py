...
def create_occlusion_scene(res_x, res_y, integr='path', maxdepth=6, reparam_max_depth=2, include_walls=False,
    ...
    texturepath = 'scenes/occlusion/grid_50.png'
    ...
    scenedict = {
        ...
        'wall': {
            'type': 'obj',
            'filename': 'scenes/occlusion/rectangle.obj',
        ...
        'sphereHidden': {
            'type': 'obj',
            'filename': 'scenes/occlusion/sphere.obj',
...
def setup_caustic_scene(hparams):
    xmlpath = 'scenes/caustic/caustic_sphere_autoReadable.xml'
    scene = create_scene_from_xml(xmlpath, resx=hparams['resx'], resy=hparams['resy'], integrator=hparams['integrator'],
                                  maxdepth=hparams['max_depth'], reparam_max_depth=hparams['reparam_max_depth'])
    params = mi.traverse(scene)
...
def setup_shadowscene(hparams):
    xmlpath = 'scenes/sphere_shadows/sphereshadows.xml'
...
def setup_cbox_scene(hparams, inset_only):
    if inset_only:
        xmlpath = 'scenes/global_illumination/cbox_aspect_cameraCloser_autoReadable.xml'
    else:
        xmlpath = 'scenes/global_illumination/cbox_aspect_autoReadable.xml'
    scene = create_scene_from_xml(xmlpath, resx=hparams['resx'], resy=hparams['resy'], integrator=hparams['integrator'],
                                  maxdepth=hparams['max_depth'], reparam_max_depth=hparams['reparam_max_depth'])
    params = mi.traverse(scene)
...
def create_highdim_scene(res_x, res_y, integr='path', maxdepth=6, reparam_max_depth=2):
    ...
    scenedict = {
        ...
        'backdrop': {
            'type': 'ply',
            'filename': 'scenes/highdim/Floor.ply',
